                            ...
                            <form className="space-y-4" onSubmit={sendData}>
                                ...
                                <div className='flex flex-row justify-between items-center'>
                                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                        ...
                                        <Link href="/signup" className="font-medium text-primary-600 hover:underline dark:text-primary-500 text-indigo-600  inline-flex space-x-1 items-center">
                                            Create Now
                                        </Link>
                                    </p>
                                    <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                        <Link href="/resetpassword" className="font-medium text-primary-600 hover:underline dark:text-primary-500 text-indigo-600  inline-flex space-x-1 items-center">
                                            Forgot Password
                                        </Link>
                                    </p>
                                </div>
