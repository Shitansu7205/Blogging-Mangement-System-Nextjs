                        ...
                        <div className="p-6 space-y-4 sm:p-8">
                            ...
                            <form className="space-y-4" onSubmit={sendData}>
                                ...
                                <div className='flex flex-row justify-between items-center'>
                                    ...
                                    <p className="text-center"><Link href='/login' className="text-indigo-600 font-medium inline-flex space-x-1 items-center"><span>Login  </span>
                                        <span>
                                        </span></Link></p>
                                </div>
                            </form>
